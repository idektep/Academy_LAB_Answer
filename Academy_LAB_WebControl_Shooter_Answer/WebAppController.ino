...
<html>
  ...
  <body class="noselect" align="center" style="background-color:black;"> 
   ...
   <div class="button-container">    
      <div class="button" ontouchstart='onTouchStartAndEnd("3")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x21BC;</span></div>
      <div class="button" ontouchstart='onTouchStartAndEnd("11")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#128299;</span></div>
      <div class="button" ontouchstart='onTouchStartAndEnd("4")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x21C0;</span></div>
      <div style="background-color:none;box-shadow:none"><h3 style="color: #4053e3;text-align:center;">&#128663; Control</h3></div>     
      <div class="button" ontouchstart='onTouchStartAndEnd("9")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x21BA;</span></div>
      <div class="button" ontouchstart='onTouchStartAndEnd("10")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x21BB;</span></div>
   </div>
   <div class="button-container">
    <div class="button" ontouchstart='onTouchStartAndEnd("7")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x2199;</span></div>
      <div class="button" ontouchstart='onTouchStartAndEnd("2")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x2193;</span></div>
      <div class="button" ontouchstart='onTouchStartAndEnd("8")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#x2198;</span></div>
      <div class="button-bg" style="background-color:none;box-shadow:none"></div>
      <div class="button-bg" style="background-color:none;box-shadow:none"></div>
      <div class="button-bg" style="background-color:none;box-shadow:none"></div>
      <div class="button-bg" style="background-color:none;box-shadow:none"></div>  
